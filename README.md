...
```
npm create cloudflare@latest -- --template=cloudflare/templates/wandering-cake-84bd
```

A live public deployment of this template is available at [https://wandering-cake-84bd.templates.workers.dev](https://wandering-cake-84bd.templates.workers.dev)
